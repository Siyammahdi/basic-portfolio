    ...
    return (
        <ComponentLayout>
            <div id='contact'>
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-2 gap-10 pb-20 mx-5 lg:mx-0">
                    ...
                    <div className="md:col-span-1 space-y-12">
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                <h4 className='text-lg lg:text-2xl font-semibold text-white'>Email</h4>
                        ...
                        <div className="flex items-center mb-4">
                            ...
                            <div>
                                <h4 className='text-lg lg:text-2xl font-semibold text-white'>Phone</h4>
                        ...
                        <div className="flex items-center">
                            ...
                            <div>
                                <h4 className='text-lg lg:text-2xl font-semibold text-white'>Address</h4>
